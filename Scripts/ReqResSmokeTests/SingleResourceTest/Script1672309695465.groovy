...
Result = WS.sendRequest(findTestObject('ResReqServices/Single Resource'))
...
WS.verifyElementPropertyValue(Result, 'data.name', 'fuchsia rose')

WS.verifyElementPropertyValue(Result, 'data.year', '2001')

WS.verifyElementPropertyValue(Result, 'data.color', '#C74375')

WS.verifyElementPropertyValue(Result, 'data.pantone_value', '17-2031')
