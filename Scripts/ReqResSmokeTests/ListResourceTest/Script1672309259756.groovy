...
Result = WS.sendRequest(findTestObject('ResReqServices/List Resources'))
...
WS.verifyElementPropertyValue(Result, 'page', '1')
...
WS.verifyElementPropertyValue(Result, 'data[0].id', '1')

WS.verifyElementPropertyValue(Result, 'data[0].name', 'cerulean')

WS.verifyElementPropertyValue(Result, 'data[0].year', '2000')

WS.verifyElementPropertyValue(Result, 'data[0].color', '#98B2D1')

WS.verifyElementPropertyValue(Result, 'data[0].pantone_value', '15-4020')
