...
Result = WS.sendRequest(findTestObject('ResReqServices/Register Successful'))
...
WS.verifyEqual(true, responseText.containsKey("token"), FailureHandling.STOP_ON_FAILURE)
